...
export class MockDB {
  ...
  private reviewReservations: ReviewReservation[] = [];
  ...
  public getReviewReservations() {
    return this.reviewReservations;
  }
  ...
  generateStories() {
    const story = new Story(
      ...
      'Action',
      'superfakelink.com',
      'This story is going to be pretty boring unless you care about Western Canadian history, fair warning :)',
      192560,
    ...
    const story2 = new Story(
      ...
      "This is the first story I've ever finished!! I hope you like it, thanks for reviewing!",
      43567,
      this.generateRandomDate(),
      8,
      []
    ...
    const story3 = new Story(
      ...
      'A super-hero action story with a bit of mystery mixed in...needs work, but plot has potential',
      98567,
      new Date(2019, 1, 10),
      10,
      []
    ...
    const story4 = new Story(
      ...
      'Drama',
      'inkitt.com/so-fake',
      'The story of Hamlet, gender bent and put in a modern setting',
      49230,
      new Date(2019, 1, 1),
      7,
      []
  ...
  generateReviews() {
    ...
    const goodReview = new ReviewReservation(
      'Uncovered',
      'shj1996',
      new Date()
    );
    const goodReview2 = new ReviewReservation(
      'Those Ills We Bear',
      'tommyj',
      this.generateRandomDate(),
      new Date(),
    ...
    const goodReview3 = new ReviewReservation(
      'Those Ills We Bear',
      'shj1996',
      this.generateRandomDate(),
      this.generateRandomDate(),
    ...
    const goodReview4 = new ReviewReservation(
      'Uncovered',
      'tommyj',
      this.generateRandomDate(),
      new Date(),
    ...
    const goodReview5 = new ReviewReservation(
      'Uncovered',
      'shj1996',
      this.generateRandomDate(),
      this.generateRandomDate(),
    ...
    for (var i = 0; i < 100; i++) {
      ...
      this.users
        .filter(user => user.getName() == reviewer)[0]
        .addReservedStory(reservation);
    ...
    for (var i = 0; i < 500; i++) {
      ...
      const review = new ReviewReservation(
        story.title,
        reviewer,
        this.generateRandomDate(),
        this.generateRandomDate(),
  ...
  addReviewReservations(revRes: ReviewReservation[]) {
    ...
    this.reviewReservations.push(...revRes);
  }
