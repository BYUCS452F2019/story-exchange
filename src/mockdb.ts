...
export class MockDB {
  ...
  generateUsers() {
    ...
    this.users = [user1, user2, user3, user4, user5, user6, user7, user8, user9, user10, user11, user12, user13, user14, user15, user16];
   }
  ...
  generateReviews() {
    ...
    for (var i = 0; i < 100; i++) {
        ...
        this.users.filter(user => user.getName() == reviewer)[0].addReservedStory(reservation);
    ...
    for (var i = 0; i < 500; i++) {
        ...
        this.users.filter(user => user.getName() == reviewer)[0].addReservedStory(review);
  ...
  addReviewReservations(revRes: ReviewReservation[]) {
    revRes.forEach(reservation => {
        ...
        this.stories.filter(story => story.title == title)[0].completedReviews.push(reservation);
    });
